...
#include<iostream>
using namespace std;
bool ratmaze(char maze[][100],int i,int j,int n,int m,char sol[][100]){
    ...
    if(i==n-1 and j==m-1){//position of chese
        ...
        cout<<endl;
        return true;//this will give all the possible solution if true then 1 will come 
    } 
    //recursive case
